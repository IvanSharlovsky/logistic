...
#define UE_PROJECT_NAME logistic
#define UE_TARGET_NAME logisticEditor
#define PLATFORM_WINDOWS_INCREASE_LINKER_HEAP_SIZE 1
#define UE_MODULE_NAME "logistic"
