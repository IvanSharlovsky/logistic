...
public: \
	DECLARE_CLASS(AResourceCarrierPawn, APawn, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/logistic"), NO_API) \
...
#define logistic_Source_logistic_ResourceCarrierPawn_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AResourceCarrierPawn); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AResourceCarrierPawn); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AResourceCarrierPawn(AResourceCarrierPawn&&); \
	NO_API AResourceCarrierPawn(const AResourceCarrierPawn&); \
public:
...
template<> LOGISTIC_API UClass* StaticClass<class AResourceCarrierPawn>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID logistic_Source_logistic_ResourceCarrierPawn_h
